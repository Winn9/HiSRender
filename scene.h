...
public:
	...
	{
		Matrix4f view_matrix = camera->get_view_matrix();
		Matrix4f projection_matrix = camera->get_proj_matrix();
		Matrix4f model_matrix = gameobject->GetModelMatrix();
		Matrix4f model_matrix_I = model_matrix.invert();
